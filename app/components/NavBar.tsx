            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                    ...
                    <Link href="/" className="flex items-center gap-2 group" onClick={handleLinkClick}>
                        ...
                        <img src="/logo.png" alt="Smile Fotilo Logo" className="h-10 w-auto object-contain brightness-0 invert" />
                    </Link>

                    {/* Desktop Menu */}
                    <div className="hidden md:flex items-center space-x-8">
                        <Link href="/#home" className="text-sm font-medium text-slate-400 hover:text-indigo-400 transition-colors">Home</Link>
                        <Link href="/#work" className="text-sm font-medium text-slate-400 hover:text-indigo-400 transition-colors">Work</Link>
                        <Link href="/#services" className="text-sm font-medium text-slate-400 hover:text-indigo-400 transition-colors">Services</Link>
                        <Link href="/about" className="text-sm font-medium text-slate-400 hover:text-indigo-400 transition-colors">About</Link>
                        <Link href="/#contact" className="px-5 py-2.5 rounded-full bg-indigo-600 text-white font-bold text-sm hover:bg-white hover:text-[#020617] transition-all shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:-translate-y-0.5">
                            Start Project
                        </Link>
                    </div>
            ...
            {isOpen && (
                <div className="md:hidden bg-[#1E293B] border-t border-white/5 absolute w-full">
                    <div className="px-4 pt-2 pb-6 space-y-1">
                        ...
                        <Link href="/#contact" onClick={handleLinkClick} className="block mt-4 text-center px-3 py-3 text-base font-bold bg-indigo-600 text-white rounded-md">
                            Start Project
                        </Link>
                    </div>
                </div>
